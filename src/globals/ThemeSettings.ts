      ...
      fields: [
        {
          ...
          options: [
            ...
            { label: 'Quicksand (rund, verspielt)', value: 'quicksand' },
          ],
          admin: {
            description: 'Schriftart für Überschriften (H1–H6). Inter wird für B2B-Websites empfohlen.',
          },
        },
        {
          name: 'bodyFont',
          ...
          admin: {
            description: 'Schriftart für normalen Text, Buttons und Formulare.',
          },
        },
      ],
    },
