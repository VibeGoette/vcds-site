...
const P: Record<string,Post> = {
  'warum-kein-vcds-crack': {
    ...
    sections:[
      ...
      {heading:'Die bessere Alternative', text:'Ein originales HEX-V2 erhalten Sie ab 294 EUR — inklusive kostenlosem Support, sieben Jahre Erfahrung und Zugang zum VCDS-Forum. Auf die Laufzeit gerechnet kostet VCDS weniger als ein Werkstattbesuch. Bei Auto-Intern sind Sie auf der sicheren Seite.', type:'tip'},
      {heading:'Zukunft: SFD macht Cracks wertlos', text:'Mit der kommenden SFD-Technologie (Schutz von Fahrzeugdiagnosen) werden Server-abhaengige Funktionen eingefuehrt. Gefaelschte Adapter und gecrackte Software werden dann komplett unbrauchbar. Wer jetzt billig kauft, zahlt spaeter doppelt.', type:'warning'},
    ],
  ...
  'qual-der-wahl-vcds': {
    ...
    sections:[
      ...
      {heading:'HEX-V2 — Der Allrounder', text:'Ab 294 EUR (3 VIN), 364 EUR (10 VIN), 594 EUR (Unlimited). USB-Verbindung, ideal fuer die Garage. Neuer 32-Bit-Prozessor, Status-LEDs, mehrplatzfaehig. Die richtige Wahl wenn Sie stationaer arbeiten.', type:'callout'},
      {heading:'HEX-NET — Fuer Profis', text:'Ab 514 EUR (10 VIN), 794 EUR (Unlimited). WLAN-Diagnose kabellos, Messwerte waehrend der Fahrt, USB-B-Schraubsicherung, VCDS-Mobile App. Die Wahl fuer Werkstaetten und mobile Diagnose.', type:'callout'},
      {heading:'Unsere Empfehlung', text:'Budget im Blick und stationaere Arbeit? HEX-V2. Professionelle Werkstatt, Probefahrten mit Diagnose, maximale Flexibilitaet? HEX-NET. Upgrade von V2 auf NET ist jederzeit moeglich. Kein funktionaler Unterschied — nur die Verbindungsart und das FIN-Limit unterscheiden sich.', type:'tip'},
    ],
  ...
  'fin-verbrauch-bei-vcds': {
    ...
    sections:[
      ...
      {heading:'Mit FIN-Verbrauch', text:'Codierungen, Anpassungen, Grundeinstellungen, Gateway-Verbauliste, Zugriffsberechtigungen, Stellglied-Diagnosen, Serviceinterval-Reset, Transportmodus-Deaktivierung. Erst bei der ersten Nutzung an einem neuen Fahrzeug wird ein FIN-Slot belegt.'},
      {text:'Wichtig: Einmal registrierte FINs koennen nicht geloescht werden und bleiben dauerhaft im Interface gespeichert. Aeltere Fahrzeuge (typischerweise vor 2002) speichern oft keine FINs in den Steuergeraeten, was zu null Verbrauch fuehrt.', type:'warning'},
      {text:'Upgrade von 3 auf 10 VIN oder Unlimited ist jederzeit moeglich — ohne Hardware-Tausch. Nur eine neue Lizenz aufspielen. Das Upgrade kostet etwas mehr als die reine Preisdifferenz.', type:'tip'},
    ],
  ...
  'welches-vcds-kaufen': {
    ...
    sections:[
      ...
      {heading:'Privatanwender (1-3 Fahrzeuge)', text:'HEX-V2 mit 3 VIN ab 294 EUR. Fuer Hobbyschrauber die gelegentlich Freunden helfen: 10 VIN ab 364 EUR.'},
      {heading:'Ambitionierte Schrauber (4-10 Fahrzeuge)', text:'HEX-V2 mit 10 VIN ab 364 EUR oder HEX-NET mit 10 VIN ab 514 EUR wenn WLAN gewuenscht.'},
      {heading:'Werkstaetten', text:'HEX-V2 Unlimited ab 594 EUR, HEX-NET Unlimited ab 794 EUR. Keine Einschraenkung, voller Funktionsumfang, kabellose Diagnose mit HEX-NET.', type:'callout'},
      {heading:'SFD — Schutz von Fahrzeugdiagnosen', text:'Neuere VW-Fahrzeuge nutzen SFD zur Zugriffsbeschraenkung. Ross-Tech arbeitet an der Unterstuetzung. VW wird voraussichtlich monatliche Gebuehren fuer den Zugang erheben. Fuer die meisten aktuellen Diagnosen ist VCDS weiterhin uneingeschraenkt nutzbar.', type:'warning'},
      {heading:'Vorsicht vor Faelschungen', text:'Der Markt ist ueberschwemmt mit gefaelschten VCDS-Interfaces. Kaufen Sie ausschliesslich bei autorisierten Fachhaendlern. Bei Unsicherheit: Fotos an info@vcds.de senden.', type:'warning'},
