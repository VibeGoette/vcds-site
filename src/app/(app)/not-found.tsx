      ...
      <main id="main" className="flex-1 flex items-center justify-center px-5 py-20">
        <div className="text-center max-w-md">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <Link href="/" className="px-5 py-2.5 bg-primary-600 text-white rounded-md font-semibold text-sm hover:bg-primary-500 transition-colors">
              Zur Startseite
            </Link>
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-4 text-sm text-slate-400">
            ...
            <Link href="/kontakt" className="hover:text-primary-600 transition-colors">Kontakt</Link>
            <Link href="/blog" className="hover:text-primary-600 transition-colors">Blog</Link>
            <Link href="/download" className="hover:text-primary-600 transition-colors">Download</Link>
          </div>
        </div>
      </main>
      <Footer />
