            ...
            <aside className="lg:col-span-2 space-y-6">
              <Card variant="muted">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center gap-3"><Icon name="phone" size={16} className="text-slate-400" /><a href={`tel:${contact.phone.replace(/[^+0-9]/g, '')}`} className="text-sm text-blue-600 font-semibold hover:underline">{contact.phone}</a></div>
