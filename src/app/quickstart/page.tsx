          ...
          <div className="bg-white border border-slate-200 rounded-2xl overflow-hidden">
            <div className="bg-slate-50 py-14 flex items-center justify-center">
              <div className="text-center">
                <div className="w-16 h-16 rounded-full bg-blue-600 text-white flex items-center justify-center text-2xl font-bold mx-auto mb-3">{step+1}</div>
          ...
          {step === steps.length - 1 && (
            <div className="bg-green-50 border border-green-100 rounded-2xl p-8 text-center">
              ...
              <div className="flex flex-wrap justify-center gap-4 text-sm">
                <a href="https://forum.vcds.de" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 text-blue-600 font-medium hover:underline"><Icon name="chat" size={14} className="text-blue-500" />Forum</a>
                <a href="https://wiki.vcds.de" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 text-blue-600 font-medium hover:underline"><Icon name="globe" size={14} className="text-blue-500" />Wiki</a>
                <a href="https://dechat.vcds.de/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 text-blue-600 font-medium hover:underline"><Icon name="users" size={14} className="text-blue-500" />Telegram</a>
              </div>
            </div>
          )}
        </div>
